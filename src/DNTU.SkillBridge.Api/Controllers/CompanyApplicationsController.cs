...
public sealed class CompanyApplicationsController(ApplicationService applicationService, CompanyService companyService, ICurrentUser currentUser) : ControllerBase
{
    [HttpGet]
